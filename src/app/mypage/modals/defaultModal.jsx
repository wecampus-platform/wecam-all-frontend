            ...
            <div className="flex flex-row gap-10 p-20">
                <div className="flex flex-col flex-1 gap-6">
                    <button className="border border-gray3 rounded-lg flex flex-col items-center justify-center text-center gap-4 px-[20px] py-[16px] ">
                        ...
                        <div className="text-xs leading-[18px] font-pretendard text-gray4">학교에서 발급 받은 재학증명서로 소속을 인증합니다.</div>
                    </button>
                ...
                <div className="flex flex-col flex-1 gap-6">
                    <button className="border border-gray3 rounded-lg flex flex-col items-center justify-center text-center gap-4 px-[20px] py-[16px] ">
                        ...
                        <div className="w-[126px] relative text-xs leading-[18px] font-pretendard text-gray4">입학 시 발급 받은 합격 증명서로 소속을 인증합니다.</div>
                    </button>
