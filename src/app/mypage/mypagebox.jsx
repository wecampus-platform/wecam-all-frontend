...
export default function MyPageBox({ title, contents, blurred = false }) {
  return (
      ...
      {blurred && (
        <>
          ...
          <div className="absolute top-[48px] bottom-0 left-0 right-0 flex flex-col items-center justify-center z-10 space-y-2">
            ...
            <Link href="/auth/verify" className="bg-point text-white text-sm px-4 py-1.5 rounded transition">소속 인증하러 가기</Link>
          </div>
        </>
      )}
