...
export default function AffiliationDetailModal({ isOpen, onClose, request, refreshRequests }) {
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
        <div className="bg-white w-[800px] max-h-[90vh] rounded shadow relative flex flex-col">
          <button
            onClick={onClose}
            className="absolute top-3 right-4 text-xl hover:text-gray-600 z-10"
          >
            &times;
          </button>

          <div className="flex-1 flex flex-col gap-4 mt-6 overflow-y-auto p-6">
            {/* 신청일 */}
