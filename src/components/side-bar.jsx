                    ...
                    <div className="flex flex-col gap-[8px]">
                        <div
                            className={`mt-[32px] w-full px-4 py-3 rounded-lg inline-flex justify-start items-center gap-2 cursor-pointer ${
                                isActive('/admin/main') ? 'bg-gray-100 text-blue-500 font-bold' : 'hover:bg-gray-100 text-zinc-600'
                            }`}
                            onClick={() => router.push('/admin/main')}
                        >
                            <div className="text-center justify-start text-xl">관리자페이지 홈</div>
                        </div>

                        <div
                            className={`w-full px-4 py-3 rounded-lg inline-flex justify-start items-center gap-2 cursor-pointer ${
                                isActive('/admin/todo') ? 'bg-gray-100 text-blue-500 font-bold' : 'hover:bg-gray-100 text-zinc-600'
                            }`}
                            onClick={() => router.push('/admin/todo/main')}
                        >
                            <div className="text-center justify-start text-xl">할 일 관리</div>
                        </div>

                        <div
                            className={`w-full px-4 py-3 rounded-lg inline-flex justify-start items-center gap-2 cursor-pointer ${
                                isActive('/admin/council-affiliation') ? 'bg-gray-100 text-blue-500 font-bold' : 'hover:bg-gray-100 text-zinc-600'
                            }`}
                            onClick={() => router.push('/admin/council-affiliation')}
                        >
                            <div className="text-center justify-start text-xl">소속 인증 관리</div>
                        </div>
                        ...
                        <Link href="/admin/invitation">
                            <div className={`w-full px-4 py-3 rounded-lg inline-flex justify-start items-center gap-2 transition-colors duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900 cursor-pointer ${
                                isActive('/admin/invitation') ? 'bg-gray-100 text-blue-500 font-bold' : 'text-zinc-600'
                            }`}>
                                <div className="text-center justify-start text-xl font-semibold">초대코드 생성</div>
                            </div>
                        </Link>
                    </div>
